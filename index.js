...
//  let clBlock=document.cloneNode(true);
// document.body.appendChild(clBlock)
...
//     h4.innerText=`title: ${element.title}, monthDuration: ${element.monthDuration} `
...
for (const itemTitle of coursesArray) {
    let main=document.createElement('div')
    main.style.border='purple 1px solid'
    main.style.padding='10px'
    main.style.width='250px'

    let divT=document.createElement('div')
    divT.innerText=`${itemTitle.title}`;
    divT.style.background ='mediumpurple'
    document.body.appendChild(divT)

    let divM=document.createElement('div')
    divM.innerText=`monthDuration: ${itemTitle.monthDuration}`
    divM.style.background ='mediumorchid'
    document.body.appendChild(divM)

    let divH=document.createElement('div')
    divH.innerText=`hourDuration: ${itemTitle.hourDuration}`
    divH.style.background ='orchid'
    document.body.appendChild(divH)

    let divU =document.createElement('div')
    divU.style.background ='plum'
    divU.innerText='modules:'
    for (const module of itemTitle.modules) {
        let li = document.createElement('li');
         li.innerText=`${module}`
        document.body.appendChild(li)
        divU.append(li)
    ...
    main.append(divT, divM, divH, divU)
}
